...
RSpec.describe "As a visitor" do
  context "When I visit '/pets'" do
    before(:each) do 
      ...
      @peppo  = @shelter_2.pets.create!(name: 'Peppo', image: 'https://adopt-dont-shop.s3-us-west-1.amazonaws.com/images/mexican_hairless_105.jpg', approximate_age: 13, sex: 'female', description: "Basically a naked molerat",  adoptable: true)
    end 
